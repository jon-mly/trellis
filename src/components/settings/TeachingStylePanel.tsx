...
interface TeachingStylePanelProps {
...
export function TeachingStylePanel({
  teachingStyle,
  onSave,
}: TeachingStylePanelProps): ReactElement {
  const t = useI18n();
  ...
  return (
    <div className="teaching-style-panel">
      <div className="teaching-style-panel-header">
        <h2 className="teaching-style-panel-title">{t.teachingStyle.title}</h2>
        <p className="teaching-style-panel-description">{t.teachingStyle.description}</p>
      </div>

      <div className="teaching-style-panel-content">
